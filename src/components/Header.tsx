      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-15">
          ...
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-md bg-[#24292f] dark:bg-[#f0f6fc] text-white dark:text-[#161b22] flex items-center justify-center shadow-xs">
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center text-sm font-semibold tracking-tight text-[#1f2328] dark:text-[#f0f6fc]">
                ...
                <span className="font-bold">security-transition-monitor</span>
              </div>

              <span className="hidden sm:inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-medium border border-[#d0d7de] dark:border-[#30363d] text-[#656d76] dark:text-[#8b949e] bg-[#f6f8fa] dark:bg-[#21262d]">
                Public
              </span>
            </div>
          </div>
